 ...
 * @author $Akshay$
 */
public class Blue_Diamond_Emulator extends javax.swing.JFrame {

    /** Creates new form Långsam */
    public Blue_Diamond_Emulator() {
        initComponents();
...
reset_game.stop();
    ...
    private void initComponents() {
        ...
        Tic_Tac_Toe_Window_Back = new javax.swing.JButton();
        ...
        getContentPane().add(Notification_Bar, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 450, 20));
        ...
        getContentPane().add(Parent_Lock, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 450, 0));
        ...
        getContentPane().add(Calendar_Window, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 450, 0));
        ...
        getContentPane().add(Calculator_Window, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 450, 0));
        ...
        getContentPane().add(Call_Window, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, 450, 680));
        ...
        getContentPane().add(Message_Window, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 450, 0));
        ...
        getContentPane().add(Contact_Window, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 450, 0));
        ...
        getContentPane().add(Games_Window, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 450, 0));
        ...
        Tic_Tac_Toe_Window_Back.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        Tic_Tac_Toe_Window_Back.setText("QUIT");
        Tic_Tac_Toe_Window_Back.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Tic_Tac_Toe_Window_BackActionPerformed(evt);
            }
        });
        Tic_Tac_Toe_Window.add(Tic_Tac_Toe_Window_Back, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 660, 150, 30));

        getContentPane().add(Tic_Tac_Toe_Window, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 450, 0));
        ...
        Menu_Calculator.setText("Calculator");
        ...
        getContentPane().add(Menu_Window, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 450, 0));
        ...
        getContentPane().add(Home_Window, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 450, 0));
        ...
        getContentPane().add(Lock_Phone, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 260, 70, 50));
        ...
        getContentPane().add(Send_Message, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 850, 70, 50));

        Copyrights.setText("©$Dollar Aksahy$");
        getContentPane().add(Copyrights, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 10, 100, -1));
        ...
        getContentPane().add(Call_Button, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 850, 70, 50));
        ...
        getContentPane().add(Make_Call_Button, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 850, 70, 50));

        jLabel1.setBackground(new java.awt.Color(180, 205, 230));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile_Operating_System/phone.png"))); // NOI18N
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-4, -2, 624, 952));
...
boolean wifi=false,sound=false,bluetooth=false,power=true;
int dot=0;
...
ResultSet cont = executeQuerry("Select * from Contacts where Sl_No=\'"+no+"\';","Blue_Diamond");
cont.next();
...
posy+=31;
JTextField info6 = new JTextField("  "+cont.getDate(6).getDate()+" "+getMonth(cont.getDate(6).getMonth()+1)+" "+(cont.getDate(6).getYear()+1900));
...
try{
ResultSet search = executeQuerry("Select * from Contacts where home_number="+number+" OR mobile_number="+number+" OR work_number="+number+";","Blue_Diamond");
if(search.next()==true){
...
scroll.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 200, 255),1,false));
Message_Convo.add(new JLabel(new ImageIcon(getClass().getResource("/Mobile_Operating_System/Message_Top.png"))),0).setBounds(180,30+dy-20,250,20);
Message_Convo.add(scroll,1);
Message_Convo.add(new JLabel(new ImageIcon(getClass().getResource("/Mobile_Operating_System/Message_Bottom.png"))),2).setBounds(180,30+dy+sh,250,20);
}
else{
txt.setBackground(new java.awt.Color(255,255,255));
scroll.setBounds(5,30+dy,250,sh);
scroll.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255,255,255),1,false));
Message_Convo.add(new JLabel(new ImageIcon(getClass().getResource("/Mobile_Operating_System/Reply_Top.png"))),0).setBounds(5,30+dy-20,250,20);
Message_Convo.add(scroll,1);
Message_Convo.add(new JLabel(new ImageIcon(getClass().getResource("/Mobile_Operating_System/Reply_Bottom.png"))),2).setBounds(5,30+dy+sh,250,20);
}
}
int times=0;
while(times*600<dy+sh+25)
{
Message_Convo.add(new JLabel(new ImageIcon(getClass().getResource("/Mobile_Operating_System/Convo_Background.png")))).setBounds(0,0+600*(times),450,600);
times++;
}
}
catch(Exception e)
...
Message_List.add(new JLabel(new ImageIcon(getClass().getResource("/Mobile_Operating_System/Empty_contact.png")))).setBounds(20, y+5,50,50);
...
try{
String qry = "SELECT * FROM (select m.number,c.name,m.sms,m.time from messages m left join contacts c on c.home_number=m.number OR c.mobile_number=m.number OR c.work_number=m.number Order by Time desc ) as Message_List group by number order by Time desc;";
...
displaySMS(msg.getString(1),msg.getString(1),msg.getString(3),(msg.getTime(4).getHours()-12)+":0"+msg.getTime(4).getMinutes()+" PM",my);
else if((msg.getTime(4).getHours()>=12)&&(msg.getTime(4).getMinutes()>=10))
displaySMS(msg.getString(1),msg.getString(1),msg.getString(3),(msg.getTime(4).getHours()-12)+":"+msg.getTime(4).getMinutes()+" PM",my);
else if((msg.getTime(4).getHours()<12)&&(msg.getTime(4).getMinutes()<10))
displaySMS(msg.getString(1),msg.getString(1),msg.getString(3),msg.getTime(4).getHours()+":0"+msg.getTime(4).getMinutes()+" AM",my);
else
displaySMS(msg.getString(1),msg.getString(1),msg.getString(3),msg.getTime(4).getHours()+":"+msg.getTime(4).getMinutes()+" AM",my);   
my+=60;
}
else {
if((msg.getTime(4).getHours()>=12)&&(msg.getTime(4).getMinutes()<10))
displaySMS(msg.getString(2),msg.getString(1),msg.getString(3),(msg.getTime(4).getHours()-12)+":0"+msg.getTime(4).getMinutes()+" PM",my);
else if((msg.getTime(4).getHours()>=12)&&(msg.getTime(4).getMinutes()>=10))
displaySMS(msg.getString(2),msg.getString(1),msg.getString(3),(msg.getTime(4).getHours()-12)+":"+msg.getTime(4).getMinutes()+" PM",my);
else if((msg.getTime(4).getHours()<12)&&(msg.getTime(4).getMinutes()<10))
displaySMS(msg.getString(2),msg.getString(1),msg.getString(3),msg.getTime(4).getHours()+":0"+msg.getTime(4).getMinutes()+" AM",my);
else
displaySMS(msg.getString(2),msg.getString(1),msg.getString(3),msg.getTime(4).getHours()+":"+msg.getTime(4).getMinutes()+" AM",my);   
my+=60;
}
}
if(my>600)
...
executeUpdate("Insert INTO Messages VALUES("+no+",false,'"+Sender_SMS.getText()+"',now());","Blue_Diamond","Message Sent Successfully");
...
executeUpdate("Insert INTO Messages VALUES("+no+",true,'"+Compose_SMS.getText()+"',now());","Blue_Diamond","Message Sent Successfully");
...
if((Edit_Year.getSelectedIndex()!=-1)&&(Edit_Month.getSelectedIndex()!=-1)&&(Edit_Day.getSelectedIndex()!=-1))
date = ""+Edit_Year.getSelectedItem()+Edit_Month.getSelectedItem()+Edit_Day.getSelectedItem();
executeUpdate("Update Contacts set Name=\'"+name+"\',Home_Number='"+no1+"',Mobile_Number='"+no2+"',Work_Number='"+no3+"',Email='"+email+"',Date_Of_Birth="+date+" where Sl_No="+slno+";","Blue_Diamond","Contact Updated Successfully");
Edit_Clear.doClick();
displayContact(slno+"");
}
catch(Exception e)
...
int op = JOptionPane.showConfirmDialog(rootPane,"Are you sure you want to delete "+Edit_Name.getText()+" ?","Delete confirmation",1,2);
if(op==0)
{
executeUpdate("Delete from Contacts where Name=\'"+Edit_Name.getText()+"\';","Blue_Diamond","Successfully Deleted");
Contact_Info.removeAll();
Edit_Contact.setSize(450,0);
Contact_Info.setSize(450,0);
Contacts.doClick();
...
caller_name=no;
try {
ResultSet name = executeQuerry("select * from contacts where home_number="+no+" || mobile_number="+no+" || work_number="+no+";","Blue_Diamond");
while(name.next()){
...
cal = executeQuerry("Select dayofweek(concat(year(now())+"+years+",'0',month(now())+"+months+",'01')),Month(now())+"+months+",year(now())+"+years+";","Blue_Diamond");
else
cal = executeQuerry("Select dayofweek(concat(year(now())+"+years+",month(now())+"+months+",'01')),Month(now())+"+months+",year(now())+"+years+";","Blue_Diamond");
cal.next();
...
Menu_Window.setSize(450,700);
    ...
    private void Tic_Tac_Toe_Window_BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Tic_Tac_Toe_Window_BackActionPerformed
Tic_Tac_Toe_Window.setSize(450,0);
Games_Window.setSize(450,700);
// TODO add your handling code here:
    }//GEN-LAST:event_Tic_Tac_Toe_Window_BackActionPerformed
...
int choice=JOptionPane.showConfirmDialog(null, "Are you sure you want to delete the selected Messages ?","Delete Confirmation",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.WARNING_MESSAGE);
if(choice==0){
for(int i=0;i<Message_List.getComponentCount();i++){
Component c = Message_List.getComponent(i);
if(c.getClass().getSimpleName().equals("JCheckBox")){
...
else if((Double.parseDouble(Workspace.getText())==0)&&(Workspace.getText().length()>1)&&(Workspace.getText().charAt(1)!='.'))
{
Workspace.setText("");
}
...
if((b.getText().equals("."))&&((Workspace.getText().equals(""))||(Double.parseDouble(Workspace.getText())==0)))
Workspace.setText("0.");
else
...
if((calculations.get(calculations.size()-2).equals("sin"))||(calculations.get(calculations.size()-2).equals("cos"))||(calculations.get(calculations.size()-2).equals("tan")))
History.append(num+") = ");
...
History.append("cos (");
Equals.doClick();
check=0;        // TODO add your handling code here:
...
setLocation(getMousePosition().x-fdx,getMousePosition().y-fdy);
    }//GEN-LAST:event_jLabel1MouseDragged

    private void jLabel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MousePressed
fdx=getMousePosition().x;
fdy=getMousePosition().y;        
...
int fdx,fdy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Blue_Diamond_Emulator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Blue_Diamond_Emulator().setVisible(true);
            }
        });
    }
...
InnerClassDrawingPanel drawpanel = new InnerClassDrawingPanel();
    ...
    private javax.swing.JButton Tic_Tac_Toe_Window_Back;
